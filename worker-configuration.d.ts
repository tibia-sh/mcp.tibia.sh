/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f5e87f41a91f4601eaeeb5c4ea02589c)
// Runtime types generated with workerd@1.20260907.1 2026-09-07 
interface __BaseEnv_Env {
	RATE_LIMITER: RateLimit;
	DEPLOY_COMMIT: "local";
	MCP: DurableObjectNamespace<import("./src/worker").TibiaWikiMcp>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "TibiaWikiMcp";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEPLOY_COMMIT">> {}
}
